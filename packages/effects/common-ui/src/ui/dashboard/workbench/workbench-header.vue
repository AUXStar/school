    ...
    <div class="card-box p-4 py-6 lg:flex">
      ...
      <div class="mt-4 flex flex-1 justify-end md:mt-0">
        ...
        <div class="mx-12 flex flex-col justify-center text-right md:mx-16">
          <span class="text-foreground/80" aria-label="项目数量"> 项目 </span>
          <span class="text-2xl" role="status" aria-live="polite">8</span>
        </div>
        <div class="mr-4 flex flex-col justify-center text-right md:mr-10">
          <span class="text-foreground/80" aria-label="团队人数"> 团队 </span>
          <span class="text-2xl" role="status" aria-live="polite">300</span>
        </div>
      </div>
    </div>
  </div>
